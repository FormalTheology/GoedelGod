...
\cite{WhatToCiteHere}.
\footnote{C.: We need a reference here; I am still
...
All results announced in this note have been 
...
in the files \texttt{ModalCollapse.thy} and \texttt{ModalSquareOfOpposition.thy} inside the folder \texttt{Formalizations/Isabelle/Meta} as well as in files inside the folder \texttt{Formalizations/Isabelle/Anderson}.
