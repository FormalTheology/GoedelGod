...
The goal of this short note is merely to remark that the modal collapse is a collapse of the modal square of opposition.
...
In the modal square of opposition (Fig. \ref{ToDo}), 
...
square (MC'): the subcontraries entail (and even imply) the 
contraries. Furthermore, in any modal logic where where the 
axiom T holds (i.e. the accessibility relation is reflexive), 
a total collapse of the modalities (MC'') occurs. 
...
\item[T] Everything that is necessary is the case:
  $$\hol{\allq \phi [\nec \phi \imp \phi]}$$ 
\item[EI] (Modal Existential Import):
  $$\hol{\pos \top}$$ 
\item[AI] Everything that is necessary is possible:
  $$\hol{\allq \phi [\nec \phi \imp \pos \phi]}$$ 
\item[MC''] Modalities collapse completely:
