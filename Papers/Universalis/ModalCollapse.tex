...
All results announced in this note have been obtained 
experimentally using interactive and automated theorem provers 
and model finders \cite{ToDo:leo,sattalax,isabelle,coq,nitpick}. 
The source codes of the experiments, as well as the resulting 
proofs and counter-models, are available in 
\url{https://github.com/FormalTheology/GoedelGod/tree/master/Formalizations/Isabelle}.
...
\cite{todo:all our previous papers}, and a detailed 
mathematical description is available in \cite{todo:ECAI}.
...
explicitly written in the source code. This reduces the need 
...
Alphabetic order has been used for the authors' names. The extent and kind of contribution of each author cannot be inferred from the order.
