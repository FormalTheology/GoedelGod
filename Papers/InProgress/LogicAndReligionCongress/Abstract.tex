...
Emendation} (cf. Appendix \ref{apx:Anderson}):  % the theorems T1, C
...
A4 and A5 are independent\footnote{
  ...
  there are models of $S$ where $A$ is true and other models of $S$ where $A$ if false. 
} 
...
in a long standing controversy.  We believe the technology employed in
