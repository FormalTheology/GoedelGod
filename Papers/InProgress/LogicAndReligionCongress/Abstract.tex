...
\item Mixed variant\footnote{Cf. Isabelle/HOL source file
    \url{Anderson/Anderson_mixed_domain.thy}} (varying domain
  ...
  logic K4B, the latter already in K).
\end{itemize}
...
\section{Bjordahl's Alternative} \label{apx:Bjordahl}
