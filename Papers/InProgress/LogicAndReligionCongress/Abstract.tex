...
\BWP{Bruno: maybe we should be more explicit about these
comments}
...
%\footnote{Cf. Isabelle/HOL source file \url{Anderson/Anderson_constant_domain.thy}} 
...
%\footnote{Cf. Isabelle/HOL source file \url{Anderson/Anderson_varying_domain.thy}} 
: In this setting we obtain the
  same results as above.

\paragraph{Mixed variant}
%\footnote{Cf. Isabelle/HOL source files \url{Anderson/Anderson_mixed_domain_1/2.thy}} 
(varying domain
...
\paragraph{Constant domain semantics}
%\footnote{Cf. Isabelle/HOL source files \url{Bjordal/Bjordal_A/B/C_constant_domain.thy}}: 
    G\"odel's axiom
...
\paragraph{Varying domain semantics}
%\footnote{Cf. Isabelle/HOL source files \url{Bjordal/Bjordal_A/B/C_varying_domain.thy}}
: The results are
  the same as above. 
