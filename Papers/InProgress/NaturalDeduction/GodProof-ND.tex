...
The calculus having only the rules shown in Figures \ref{fig:PropositionalRules}, \ref{fig:Classical}, \ref{fig:QuantifierRules} and \ref{fig:EqualityRules} is named \ND, while the calculus with the additional rules shown in Figure \ref{fig:NDK} is named \NDK.
