...
\author{Annika Siders\inst{1} \and Bruno Woltzenlogel Paleo\inst{2}\thanks{Both co-authors contributed equally to this paper. Author order is alphabetical by surname. Bruno Woltzenlogel Paleo is the corresponding author.}}
...
\noindent
\textbf{Keywords: } Higher-Order Modal Logics, Ontological Proof, Natural Deduction
...
%Difference in the formalizations of Leibniz and Gödel? Why did Gödel change to conjunction? 
