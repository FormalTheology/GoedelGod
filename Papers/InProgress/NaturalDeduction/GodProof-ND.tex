...
the extra box modality in Anderson's emended Definition D\ref{A:D1}, the modified proof below uses the modal axiom T.
...
\UIC{\ldots\footnote{The formulas are ommitted here due to lack of space.}} \doubleLine \RightLabel{$\all_E$ x 2}
\UIC{\ldots}
\BIC{$P(\varphi)$}
\AXC{$\subproof_{11}$} \dashedLine 
\UIC{$  G(\gamma)$} \dottedLine \RightLabel{D\ref{A:D1}}
