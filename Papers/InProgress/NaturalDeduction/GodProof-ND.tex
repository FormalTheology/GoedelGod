...
Because of Anderson's emendations to Axiom 1 and Definitions 1 and 2, the proof of Lemma 1 has to be modified\footnote{Due to lack of space, the instantiation of Axiom \ref{A:A2} is ommitted in the emended proof of Lemma \ref{A:L1}.} as well.
