...
\begin{prooftree}
\AXC{}\RightLabel{$1$}
\UIC{$P s$}\RightLabel{$\imp_I^1$}
\UIC{$P s\imp P s$}
\AXC{}\RightLabel{$2$}
\UIC{$P s$}\RightLabel{$\imp_I^2$}
\UIC{$P s\imp P s$}\RightLabel{$\wedge_I$}
\BIC{$P s\biimp P s$}\RightLabel{$\forall_I$}
\UIC{$\forall P. P s\biimp P s$}\dottedLine
\UIC{$s=s$}
\end{prooftree}
\end{footnotesize}
...
\UIC{$P(\lambda x.\rho(x)) \biimp \nec \rho(\gamma)$}\RightLabel{$\wedge_E$}
\UIC{$P(\lambda x.\rho(x)) \imp \nec \rho(\gamma)$}
\AXC{$ $} \RightLabel{4}
...
\UIC{$ P(\varphi)\biimp \nec \varphi(\gamma)$}  \RightLabel{$\wedge_E$}
\UIC{$ P(\varphi)\imp \nec \varphi(\gamma)$}  \RightLabel{$\imp_E$}
...
\bibitem[{\itshape Benzm\"uller \& Woltzenlogel Paleo(2016)}]{IJCAI2016}
Benzm\"uller, C. \& Woltzenlogel Paleo, B. 2016. {\itshape The Inconsistency in G\"odel's Ontological Argument: A Success Story for AI in Metaphysics}. International Joint Conference on Artificial Intelligence - IJCAI. 
...
\bibitem[{\itshape Benzm\"uller \& Woltzenlogel Paleo(2014)}]{WADT}
Benzm\"uller, C. \& Woltzenlogel Paleo, B. 2014. {\itshape On Logic Embeddings and G\"odel's God}. Recent Trends in Algebraic Development Techniques. 
% @inproceeding{WADT,
...
\bibitem[{\itshape Benzm\"uller \& Woltzenlogel Paleo(2015)}]{SpiritualQuest}
Benzm\"uller, C. \& Woltzenlogel Paleo, B. 2015. {\itshape Experiments in Computational Metaphysics: G\"odel's Proof of God's Existence}. Science and Spiritual Quest: Proceedings of the 9th All India Students' Conference on Science and Spiritual Quest (IIT Kharagpur, 30th October -- 1st November). vol. 9. pp. 23--40. 
...
\bibitem[{\itshape Benzm\"uller \& Woltzenlogel Paleo(2015)}]{ReasoningWebSummerSchool}
Benzm\"uller, C. \& Woltzenlogel Paleo, B. 2015. {\itshape Higher-Order Modal Logics: Automation and Applications}. Reasoning Web. Web Logic Rules - 11th International Summer School 2015, Berlin, Germany, July 31 - August 4, 2015, Tutorial Lectures. pp. 32--74. 
...
\bibitem[{\itshape Benzm\"uller \& Woltzenlogel Paleo(2015)}]{CSRModalLogicInCoq}
Benzm\"uller, C. \& Woltzenlogel Paleo, B. 2015. {\itshape Interacting with Modal Logics in the Coq Proof Assistant}. Computer Science - Theory and Applications - 10th International Computer Science Symposium in Russia, {CSR} 2015, Listvyanka, Russia, July   13-17, 2015, Proceedings. pp. 398--411. 
...
\bibitem[{\itshape Benzm\"uller \& Woltzenlogel Paleo(2014)}]{ECAI2014}
Benzm\"uller, C. \& Woltzenlogel Paleo, B. 2014. {\itshape Automating G{\"{o}}del's Ontological Proof of God's Existence with Higher-order Automated Theorem Provers}. ECAI 2014 - 21st European Conference on Artificial Intelligence, 18-22 August 2014, Prague, Czech Republic - Including Prestigious Applications of Intelligent Systems (PAIS 2014), pp. 93--98. 
...
\bibitem[{\itshape Benzm\"uller \& Woltzenlogel Paleo(2014)}]{SquareOfOpposition}
Benzm\"uller, C. \& Woltzenlogel Paleo, B. 2014. {\itshape Formalization and Automated Verification of G\"odel's Proof of God's Existence}. 4th World Congress on the Square of Opposition, pp. 24--25. 
...
\bibitem[{\itshape Benzm\"uller \& Woltzenlogel Paleo(2014)}]{WADTPreProceedings}
Benzm\"uller, C. \& Woltzenlogel Paleo, B. 2014. {\itshape On Logic Embeddings and G\"odel's God}. 22nd International Workshop on Algebraic Development Techniques, pp. 8--9. 
...
\bibitem[{\itshape Benzm\"uller \& Woltzenlogel Paleo(2016)}]{ModalCollapse}
Benzm\"uller, C. \& Woltzenlogel Paleo, B. 2016. {\itshape The Modal Collapse as a Collapse of the Modal Square of Opposition}. Studies in Universal Logic, Springer. pp. 1--7. 
...
\bibitem[{\itshape Benzm\"uller \& Woltzenlogel Paleo(2013)}]{IsabelleGod}
Benzm\"uller, C. \& Woltzenlogel Paleo, B. 2013. {\itshape G{\"{o}}del's God in Isabelle/HOL}. Archive of Formal Proofs. 
% @article{IsabelleGod,
%   author    = {Benzm?ller, Christoph and Woltzenlogel Paleo, Bruno},
...
\bibitem[{\itshape Benzm\"uller \& Woltzenlogel Paleo(2013)}]{IWIL}
Benzm\"uller, C. \& Woltzenlogel Paleo, B. 2013. {\itshape G{\"{o}}del's God on the Computer}. 10th International Workshop on the Implementation of Logics. pp. 1--2.
...
Benzm\"uller, C. \& Woltzenlogel Paleo, B. 2013. {\itshape Automated Verification and Reconstruction of G\"odel's Proof of God's Existence}. Journal of the Austrian Computer Society. pp. 4--6.
