...
the proof of Lemma \ref{A:L1}, which is the only part of the argument that depended on Axioms \ref{A:A4} and \ref{A:A5} and Definitions \ref{A:D2} and \ref{A:D3}. The modified proof is shown below. 
