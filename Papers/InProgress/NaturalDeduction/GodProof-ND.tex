...
\begin{small}
\begin{prooftree}
\AXC{$\subproof_{13}$ and $\subproof_{14}$} \dashedLine \RightLabel{$\wedge_I$}
...
\paragraph{Acknowledgements:} This work was supported by an Stipendium of the \"Osterreichische Akademie der Wissenschaften (APART). We thank Christoph Benzm\"uller for collaborations on several related works.
