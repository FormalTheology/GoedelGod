...
Modal logics extend the usual formal logic language with modal
...
not as well-developed as for classical logics. Current deduction tools
...
modal logics and their applications \cite{ToDo:StephanMerz}. Recently,
first-order automated deduction techniques based on tableaux, sequent
calculi and connection calculi have been generalized to cope with
modalities directly and a few new provers have been implemented
\cite{JensOtten}.
...
to study this question. Our answer is positive. The \Coq proof
...
described in Section \ref{sec:modal}) provides a user experience where
...
it is beyond reach of specialized propositional and first-order
