...
\begin{calculus}
{An arbitrary natural deduction calculus}
...
\section{Convenient Modal Lemmas}


\noindent 
The following lemmas are quite convenient. The first is a
kind of modus ponens applicable to formulas under the scope of a modal
operator. The second allows pushing negations inside modalities.
