    ...
    \begin{columns}[t]
      \begin{column}{.49\linewidth}
        \begin{block}{\large Motivation} 
          \includegraphics[width=\textwidth]{VisionLeibniz}
        \end{block}
      \end{column}
      \hfill
      \begin{column}{.48\linewidth}
        \begin{block}{\large Application: Gödel's Ontological Argument
          for the Existence of God}
           \includegraphics[width=\textwidth]{GoedelInconsistency}
        \end{block}
      \end{column}
    \end{columns} \vskip-3ex
    \begin{columns}[t]
      \begin{column}{.33\linewidth}
        \begin{block}{\large Scott's vs. Gödel's Version} 
          \includegraphics[width=\textwidth]{VisionLeibniz}
        \end{block}
      \end{column}
      \hfill
      \begin{column}{.33\linewidth}
        \begin{block}{\large Technique: Semantic Embedding in HOL}
          \includegraphics[width=\textwidth]{SemanticEmbedding}
        \end{block}
      \end{column}
     \begin{column}{.33\linewidth}
        \begin{block}{\large Application: Gödel's Ontological Argument
