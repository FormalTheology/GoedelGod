    ...
    \begin{columns}[t]
      \begin{column}{.49\linewidth}
        \begin{block}{\large Motivation} 
          \includegraphics[width=\textwidth]{./Images/VisionLeibniz}
        \end{block}
      \end{column}
      \hfill
      \begin{column}{.48\linewidth}
        \begin{block}{\large Application: Gödel's Ontological
            Argument} \centering
           \includegraphics[width=\textwidth]{./Images/GoedelInconsistency}
        \end{block}
      \end{column}
    ...
    \begin{columns}[t]
      \begin{column}{.33\linewidth}
        \begin{block}{\large Scott's vs. Gödel's Version} 
          \includegraphics[width=\textwidth]{./Images/Scott_vs_Goedel}
        \end{block}
      \end{column}
      \hfill
      \begin{column}{.33\linewidth}
