...
% Although G\"odel's notion of positive property is not exactly the same
% as Leibniz's notion of perfection, 
...
% \centerline{\includegraphics[width=\textwidth]{./InconsistencyIsabelleK.png}}
% \caption{Inconsistency of G\"odel's Axioms in HOML \K verified in Isabelle/HOL} \label{InconsistencyIsabelleK}
% \end{figure}


% \begin{figure}[t]{0.48\textwidth}
% \centerline{\includegraphics[width=\textwidth]{./Scott_S5U.png}}
% \caption{Full Automation of T3 in \SFiveU; Consistency of Scott's
%   Axioms;  Automatic Verification of Modal Collapse} \label{Scott_S5U}
% \end{figure}
...
% Part of the file is displayed in Fig.~\ref{LEO-Proof}.
