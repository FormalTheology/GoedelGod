...
\includegraphics[width=0.7\textwidth]{Derivation}
...
\Proof. mv.
intro p. intro H1. intro H2. dia_e H1. apply H. box_e H2 H3. exact H3.
\Qed.

\Theorem dia_box_false_to_false_object: [(dia (box mFalse))] -> [mFalse].
\Proof.
intro H. intro w.
exists (dia (dia mFalse)).
split.
