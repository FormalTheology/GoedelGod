...
\author{Christoph Benzm\"uller\institute{Freie Universit\"at Berlin,
    Germany, email: c.benzmueller@fu-berlin.de}
...
non-reviewed) publications on the subject \cite{J30,W50,J29,J28}.
...
\begin{example}\label{ex1} %\footnote{Maybe we should instead use an axiom or theorem from G{\"o}del's proof?}
  ...
  $\beta\eta$-normal \HOL term of type $\sigma$
...
for example, shows that this theorem follows from axioms A2 and A1
...
\text{CO'} & \emptyset\, \text{(no goal, check for consistency)} & \text{A1}(\supset), \text{A2}, \text{D2'}, \text{D3}, \text{A5} & \text{KB} & \text{UNS} & 7.5/7.8 & \text{---/---} & \text{---/---} \\ 
 & & \text{A1}, \text{A2}, \text{D1}, \text{A3}, \text{A4}, \text{D2'}, \text{D3}, \text{A5} & \text{KB} & \text{UNS} & \text{---/---} & \text{---/---} & \text{---/---} \\ 
\end{array}$
\end{minipage}
}
...
the interested theoretical philosophy and theology communities. This
is relevant, since philosophers are sometimes imprecise about the
very details of the logics they employ.
...
\paragraph{Acknowledgments} This work has been supported by the German Research Foundation under grants BE 2501/9-1 and BE 2501/11-1. %We thank the anonymous reviewers for their comments and suggestions.
