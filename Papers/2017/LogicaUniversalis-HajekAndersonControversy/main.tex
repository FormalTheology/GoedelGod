...
$\exists x. \mathit{God}(x)$ as intended.  Hence, contingent truth
implies necessary truth, or, in other words, there are no unnecessary
contingent truths. In fact, one may even go as far and interpret MC as a result
against free will.
%
...
the existence relation.\footnote{EDNOTE: This part was
  misleading/wrong before; I reworded it.} This technical solution
...
\footnote{Ideally, Logica Universalis should provide means for
  permanent storing of such additional material.}
...
\begin{figure}
\begin{sideways}
%\includegraphics[width=1.2\textwidth]{Summary.png} \fbox{EDNOTE: to be removed}
\end{sideways}
%
\begin{sideways}
%\scalebox{.9}{
...
least to some degree, a realises Leibniz' dream of a characteristica universalis
