...
\marginpar{\scriptsize Bruno: I think the numbers (A1, A2,.., D1,..D3, L1,..,L3,T) should be in the left with a description environment, as they were before. I think it looked nicer before. Can I change it back?}
