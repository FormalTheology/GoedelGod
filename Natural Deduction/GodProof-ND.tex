...
\noindent
\textbf{Note:} the formal proof above uses the necessitation rule of the basic modal logic \textbf{K} and  Axiom 4, which corresponds to a restricted form of necessitation. 
