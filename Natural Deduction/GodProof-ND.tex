...
\section{Crisis in the calculus}
...
This collapse of the sytem is proved in (Fitting, 2002) and he provides two solutions by the modifications of the axioms, see chapter 11 section 8-11. The argument may require that one doesn't instantiate the second order quantifier with $A$ directly but with $\lambda x.A$ to make $A$ a property. But still we have $(\lambda x.A)(y)\equiv A$ because $A$ is constant. 
