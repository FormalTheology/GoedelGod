...
\begin{calculus}
{The natural deduction calculus \ND}
{fig:ND}

\vspace{1em}

\s\s\s
\infer[\imp_I^n]{A \imp B}{ \infer*{B}{A^n} }
\s\s\s
...
\s
\infer[\ex_E]{A[\alpha]}{ \ex x. A[x] }

\vspace{1em}


ToDo: State eigen-variable conditions
\end{calculus}


\begin{calculus}
{\NDK: Rules for Modal Operators}
{fig:NDK}
\s\s\s
\infer[\nec_I]{\nec A}{A}
\s\s
...
\UIC{$\nec\nec \ex x. G(x)$}\RightLabel{$\imp$ I, 1}
\UIC{$\nec \ex x. G(x)\imp\nec\nec \ex x. G(x)$} \RightLabel{propositional logic}
\UIC{$\neg\nec\nec \ex x. G(x)\imp\neg  \nec \ex x. G(x)$}\RightLabel{$\nec$ I}
\UIC{$\nec(\neg\nec\nec \ex x. G(x)\imp\neg  \nec \ex x. G(x))$}
\AXC{Axiom K} \dashedLine 
\BIC{$\nec\neg\nec\nec \ex x. G(x)\imp\nec\neg  \nec \ex x. G(x)$} \RightLabel{definition of $\pos$}
 \UIC{$\nec\pos\neg\nec \ex x. G(x) \imp\nec\neg\nec \ex x. G(x) $}
...
\UIC{$\neg\nec \ex x. G(x) \imp \neg\ex x. G(x)$}\RightLabel{$\imp$ E}
 \BIC{$ \neg\ex x. G(x)$} \RightLabel{$\nec$ I}
\UIC{$\nec \neg\ex x. G(x)$}  \RightLabel{definition of $\pos$}
\UIC{$\neg \pos\ex x. G(x)$} 
...
\UIC{$ \pos\ex x. G(x)$} \RightLabel{$\imp$ E}
 \BIC{$ \bot$} \RightLabel{$\imp$ I, 1}
 \UIC{$\neg\nec\pos\neg\nec \ex x. G(x)$}
\AXC{ Axiom B} \dashedLine 
\UIC{$ \neg\nec \ex x. G(x)\imp \nec\pos\neg\nec \ex x. G(x)$} \RightLabel{propositional logic}
\UIC{$ \neg \nec\pos\neg\nec \ex x. G(x)\imp  \nec \ex x. G(x)$} \RightLabel{$\imp$ E}
 \BIC{$ \nec \ex x. G(x)$}
\end{prooftree}
\end{small}
...
\UIC{$ \pos\ex x. G(x)$} \RightLabel{$\imp$ E}
 ...
 \UIC{$\neg\nec\pos \neg \ex x. G(x)$}
\AXC{ Axiom B} \dashedLine 
\UIC{$ \neg \ex x. G(x)\imp\nec\pos \neg \ex x. G(x)$} \RightLabel{propositional logic}
\UIC{$ \neg\nec\pos \neg \ex x. G(x)\imp  \neg  \neg \ex x. G(x)$} \RightLabel{$\imp$ E}
 \BIC{$ \neg  \neg \ex x. G(x)$}\RightLabel{$ \neg  \neg$ E}
 \UIC{$  \ex x. G(x)$}
\end{prooftree}
...
\UIC{$A\imp B$} 
\AXC{$\nec A ^1 $}\RightLabel{$\nec$ E}
\UIC{$A$} \RightLabel{$\imp$ E}
 \BIC{$ B$} \RightLabel{$\nec$I}
\UIC{$ \nec B$} \RightLabel{$\imp$ I, 1}
 \UIC{$\nec A\imp \nec B$}  \RightLabel{$\imp$ I, 2}
 \UIC{$\nec(A\imp B)\imp  (\nec A\imp \nec B)$}
\end{prooftree}
\end{small}
...
\begin{prooftree}
\AXC{$A^1 $}\dashedLine
\UIC{$ B$} \RightLabel{$\imp$ I, 1}
\UIC{$A\imp B$} \RightLabel{rule N}
\UIC{$\nec(A\imp B)$} 
\AXC{Axiom K}\dashedLine
\UIC{$\nec(A\imp B)\imp  (\nec A\imp \nec B)$} \RightLabel{$\imp$ E}
\BIC{$\nec A\imp \nec B$} 
\AXC{$\nec A ^1 $}\RightLabel{$\imp$ E}
\BIC{$\nec B$}
\end{prooftree}
\end{small}
