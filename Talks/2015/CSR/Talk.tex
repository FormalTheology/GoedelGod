...
\title[Modal Interactive Theorem Proving]
{Interacting with Modal Logics in the Coq Proof Assistant}


\author[Bruno Woltzenlogel Paleo]{
\textbf{Christoph Benzm\"{u}ller} and \alert{\textbf{Bruno Woltzenlogel Paleo}}\\
...
\date[16.07.2015]{CSR, Listvyanka, 16th of July 2015}
