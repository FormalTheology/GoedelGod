...
\AXC{$\textbf{C1: } \pos \ex x. G(x)$}
	...
	\BIC{$\textbf{T3: } \phantom{\nec \ex x. G(x)} $}
\end{prooftree}

\end{frame}

\begin{frame}{Natural Deduction Calculus} \small
...
\begin{frame}{Detailed Natural Deduction Proof of T1 and C1}
\begin{prooftree}
        \AXC{\textbf{A2}} \dashedLine
...
\begin{frame}{Natural Deduction Calculus}{Rules for Modalities} \small
...
\begin{frame}{Detailed Natural Derivation of part of T2} \small
