...
\title{Gödel's Proof of God's Existence}
...
\begin{frame}
  \titlepage
\colorbox{gray}{\includegraphics[height=2.5cm]{$HOME/GoedelGod/Talks/FU-Berlin/Images/Books/buch7.jpg}
} %$
\hfill
\colorbox{gray}{\includegraphics[height=2cm]{$HOME/GoedelGod/Talks/FU-Berlin/Images/ND.png}}%$
...
\item Experiments: systematic study of Gödel's argument
...
\onslide*<1-2>{
\onslide*<1>{\colorbox{gray}{\includegraphics[width=.95\textwidth]{$HOME/GoedelGod/Talks/FU-Berlin/Images/News/spiegel1}}}%
\onslide*<2>{\colorbox{gray}{\includegraphics[width=\textwidth]{$HOME/GoedelGod/Talks/FU-Berlin/Images/News/spiegel2}}}%$
\vskip1em
Germany \\
- Telepolis \& Heise \\
- Spiegel Online \\
...
%\onslide*<3>{\colorbox{gray}{\includegraphics[width=\textwidth]{$HOME/GoedelGod/Talks/FU-Berlin/Images/News/welt}}}
\end{minipage} \hfill
%
...
\begin{frame}{Introduction} \large
\colorbox{gray}{\includegraphics[width=\textwidth]{$HOME/GoedelGod/Talks/FU-Berlin/Images/News/MacBookGrab}} %$
\pause
\vfill
...
\includegraphics[scale=0.22]{$HOME/GoedelGod/Talks/FU-Berlin/Images/ProofOfT2Boxed.pdf}%$
\end{frame}
