...
lemma L9': "\<not>(P G) \<or> (G \<^bold>\<sqsupset> E)" 
  using L6' L7' L8' notcontains_def by metis
...
(* Note that impossible objects contain any property.
Therefore, any impossible object contains existence *)
