...
text {* The types @{text "i"} for possible worlds (or states) and @{text "mu"} for individuals 
are introduced. *}

  typedecl i     -- "the type for possible worlds" 
  typedecl mu    -- "the type for indiviuals"      

text {* Possible worlds are connected by an accessibility relation .*} 
...
text {* The model finder Nitpick confirms that the axioms and definitions above are consistent. 
...
"sledgehammer [provers = remote_leo2 remote_satallax]"}. This successful attempt then suggest to 
